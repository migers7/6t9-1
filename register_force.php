...
$hasAccess = ["rex", "aks", "nana", "nitu", "dynamo", "peacefrog", "sixt9", "battletosettle1646", "battletosettle0621", "battletosettle7953", "battletosettle1509", "pronoy", "sajeeb"
    , "sherly"];

if(in_array($username, $hasAccess) == false) {
