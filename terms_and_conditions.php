...
<div class="container">
    ...
    <p>By downloading or using the app, these terms will automatically apply to you – you should make sure
        ...
        property rights related to it, still belong to Team 6t9.</p>
    <p>Team 6t9 is committed to ensuring that the app is as useful and efficient as possible. For
    ...
    <p>The SixT9 app stores and processes personal data that you have provided to us, in order to provide
        ...
        the SixT9 app won’t work properly or at all. </p>
    <p>You should be aware that there are certain things that Team 6t9 will not take responsibility
        for. Certain functions of the app will require the app to have an active internet connection. The connection
        can be Wi-Fi, or provided by your mobile network provider, but Team 6t9 cannot take responsibility
    ...
    <p>Along the same lines, Team 6t9 cannot always take responsibility for the way you use
        the app i.e. You need to make sure that your device stays charged – if it runs out of battery and
        you can’t turn it on to avail the Service, Team 6t9 cannot accept responsibility.</p>
    <p>With respect to Team 6t9’s responsibility for your use of the app, when you’re using
        ...
        it available to you. Team 6t9 accepts no liability for any loss, direct or indirect,
    ...
    <p>At some point, we may wish to update the app. The app is currently available on Android – the
        ...
        app. Team 6t9 does not promise that it will always update the app so that it is relevant
    ...
    <p>If you have any questions or suggestions about my Terms and Conditions, do not hesitate
        to contact me. Send an email to contact6t9@gmail.com
    </p>
