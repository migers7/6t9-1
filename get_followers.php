...
$subsql = "SELECT _id, other, relationType FROM user_relations WHERE username = '$username' AND (relationType = 'confirm' OR relationType = 'friends') AND _id > $id ORDER BY _id ASC LIMIT 10";
